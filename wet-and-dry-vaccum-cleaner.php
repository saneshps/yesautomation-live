...
<head>
    ...
    <!-- canonical -->
    <link href="https://www.yesautomation.ae/wet-and-dry-vaccum-cleaner.php" rel="canonical">
    <!--// canonical -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <p>Robust and flexible, the perfect wet and dry vacuum cleaners for small to medium areas with
                        patented float system. Wet and dry option ensures added benefits for easy operation. Available
                        for daily, weekly, and monthly requirements.</p>

                    <div class="row top">
                        <div class="col-md-4">
                            <p class="text-center"><b>SW21 Combi</b></p>
                            <img src="images/cleaning-machines/sw21_combi.webp" class="img-responsive"
                                alt="Wet & Dry Vacuum Cleaner">
                        </div>
                        <div class="col-md-4">
                            <p class="text-center"><b>SW21 Aqua</b></p>
                            <img src="images/cleaning-machines/sw21_aqua.webp" class="img-responsive"
                                alt="Wet & Dry Vacuum Cleaner">
                        </div>
