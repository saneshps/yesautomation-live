  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban5.png" alt="Sweeper Machines in UAE">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Sweeper Machines</h2>
          <p>A perfect solution to remove dust and dirt from all hard floors. The ride-on sweeper machines are small enough to fit into an elevator and is maneuverable enough to reach the tight corners. They are indispensable for occasional and maintenance cleaning of hard surface areas. Available for daily, weekly and monthly hires.</p>
