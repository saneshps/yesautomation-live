...
<head>
    ...
    <!-- canonical -->
    <link href="https://www.yesautomation.ae/carpet-cleaning.php" rel="canonical">
    <!--// canonical -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <p>Compact and lightweight carpet cleaning cleaners (TW 300 S and TW 412) ideal for basic cleaning
                        of small to medium sized surfaces. For large areas, TW 600 and TW Compact carpet cleaners
                        provides the perfect solution for cleaning corners, edges, and stairs. Available for daily,
                        weekly, and monthly hires.</p>

                    <div class="row top">
                        <div class="col-md-4">
                            <p class="text-center"><b>TW300S</b></p>
                            <img src="images/cleaning-machines/tw300s.webp" class="img-responsive"
                                alt="Carpet Cleaning">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <img src="images/cleaning-machines/tw-compact.webp" class="img-responsive"
                                alt="Carpet Cleaning">
                        </div>
                        <div class="col-md-4">
                            <p class="text-center"><b>Hurrican</b></p>
                            <img src="images/cleaning-machines/hurrican.webp" class="img-responsive"
                                alt="Carpet Cleaner">
                        </div>
                    </div>
