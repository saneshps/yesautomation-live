...
<head>
    ...
    <!-- canonical -->
    <link href="https://www.yesautomation.ae/ride-on-scrubber-dryer.php" rel="canonical">
    <!--// canonical -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <p>Our Ride-on scrubber dryers are known for its manoeuvrability and speed. Stable and robust models
                        with a good turning circle and speed-dependent water dosing technology. Available for daily,
                        weekly, and monthly hires. </p>

                    <div class="row top">
                        <div class="col-md-4">
                            <p class="text-center"><b>RA500 Sauber</b></p>
                            <img src="images/cleaning-machines/ra500sauber.webp" class="img-responsive"
                                alt="Ride On Scrubber Dryer">
                        </div>
                        <div class="col-md-4">
                            <p class="text-center"><b>RA900 Sauber</b></p>
                            <img src="images/cleaning-machines/ra900-sauber.webp" class="img-responsive"
                                alt="Ride On Scrubber Dryer">
                        </div>
